            ...
            <div className="flex items-start justify-center gap-6">
              <div className="flex flex-col items-center gap-2" style={{ width: '200px' }}>
                <button
                  ...
                  className="w-full px-6 py-4 bg-slate-700 hover:bg-slate-800 text-white rounded-lg font-bold text-base transition-all flex items-center justify-center gap-2 shadow-lg hover:shadow-xl"
                >
                  <Phone className="w-5 h-5" />
                  Demo Call
                </button>
                <p className="text-xs text-slate-500 text-center">Pre-recorded simulation, no mic needed</p>
              </div>

              <span className="text-slate-400 font-bold text-sm mt-4">or</span>

              <div className="flex flex-col items-center gap-2" style={{ width: '200px' }}>
                <button
                  onClick={() => { setUseLiveMode(true); startCall(); }}
                  className="w-full px-6 py-4 bg-blue-500 hover:bg-blue-600 text-white rounded-lg font-bold text-base transition-all flex items-center justify-center gap-2 shadow-lg hover:shadow-xl"
                >
                  <Mic className="w-5 h-5" />
                  Start Live Call
                </button>
                <p className="text-xs text-slate-500 text-center">Uses your microphone for real calls</p>
              </div>
            </div>
          </div>
        ) : (
